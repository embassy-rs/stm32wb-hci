...
use crate::event::command::{
    ChannelMapParameters, EncryptedBlock, EncryptedReturnParameters, LeLongTermRequestReply,
...
use bt_hci::cmd::controller_baseband::{
    ...
    Reset, SetControllerToHostFlowControl, SetEventMask,
};
use bt_hci::cmd::info::{
    ReadBdAddr as CmdReadBdAddr, ReadLocalSupportedCmds, ReadLocalSupportedFeatures,
...
pub trait HostHci {
    ...
    async fn set_controller_to_host_flow_control(
        &self,
    ...
    async fn number_of_completed_packets(
        &self,
    ...
    /// event is generated.
    async fn read_local_version_information(&self) -> Result<LocalVersionInfo, Error>;
    ...
    /// event is generated.
    async fn read_local_supported_commands(&self) -> Result<LocalSupportedCommands, Error>;
    ...
    /// event is generated.
    async fn read_local_supported_features(&self) -> Result<LocalSupportedFeatures, Error>;
    ...
    /// generated.
    async fn read_bd_addr(&self) -> Result<ReadBdAddr, Error>;
    ...
    async fn read_rssi(&self, conn_handle: ConnectionHandle) -> Result<ReadRssi, Error>;
    ...
    /// generated.
    async fn le_read_buffer_size(&self) -> Result<LeReadBufferSize, Error>;
    ...
    /// event is generated.
    async fn le_read_local_supported_features(&self) -> Result<LeSupportedFeatures, Error>;
    ...
    async fn le_set_random_address(&self, bd_addr: crate::BdAddr) -> Result<(), Error>;
    ...
    /// generated.
    async fn le_read_advertising_channel_tx_power(&self) -> Result<i8, Error>;
    ...
    async fn le_set_advertising_data(&self, data: &[u8]) -> Result<(), Error>;
    ...
    /// is generated.
    async fn le_set_scan_response_data(&self, data: &[u8]) -> Result<(), Error>;
    ...
    async fn le_set_advertising_enable(&self, enable: bool) -> Result<(), Error>;
    ...
    /// generated.
    async fn le_set_scan_parameters(&self, params: &ScanParameters) -> Result<(), Error>;
    ...
    /// event.
    async fn le_set_scan_enable(&self, enable: bool, filter_duplicates: bool) -> Result<(), Error>;
    ...
    /// been completed.
    async fn le_create_connection(&self, params: &ConnectionParameters) -> Result<(), Error>;
    ...
    async fn le_create_connection_cancel(&self) -> Result<(), Error>;
    ...
    /// generated.
    async fn le_read_white_list_size(&self) -> Result<u8, Error>;
    ...
    /// generated.
    async fn le_clear_white_list(&self) -> Result<(), Error>;
    ...
    async fn le_add_device_to_white_list(&self, addr: crate::BdAddrType) -> Result<(), Error>;
    ...
    /// is generated.  When a Controller cannot add a device to the White List because there is no
    /// space available, it shall return [`OutOfMemory`](Status::OutOfMemory).
    async fn le_add_anon_advertising_devices_to_white_list(&self) -> Result<(), Error>;
    ...
    /// event is generated.
    async fn le_remove_device_from_white_list(&self, addr: crate::BdAddrType) -> Result<(), Error>;
    ...
    /// A [Command Complete](crate::event::command::ReturnParameters::LeRemoveDeviceFromWhiteList)
    /// event is generated.
    async fn le_remove_anon_advertising_devices_from_white_list(&self) -> Result<(), Error>;
    ...
    /// generated.
    async fn le_read_channel_map(
        &self,
        conn_handle: ConnectionHandle,
    ) -> Result<ChannelMapParameters, Error>;
    ...
    async fn le_read_remote_used_features(
        &self,
        conn_handle: ConnectionHandle,
    ) -> Result<(), Error>;
    ...
    async fn le_encrypt(&self, params: &AesParameters) -> Result<EncryptedReturnParameters, Error>;
    ...
    async fn le_rand(&self) -> Result<LeRandom, Error>;
    ...
    async fn le_start_encryption(&self, params: &EncryptionParameters) -> Result<(), Error>;
    ...
    /// is generated.
    async fn le_long_term_key_request_negative_reply(
        &self,
        conn_handle: ConnectionHandle,
    ) -> Result<LeLongTermRequestReply, Error>;
    ...
    /// is generated.
    async fn le_read_supported_states(&self) -> Result<LeReadSupportedStates, Error>;
    ...
    /// generated.
    async fn le_receiver_test(&self, channel: u8) -> Result<(), Error>;
...
where
    T: ControllerCmdSync<CmdLeReadBufferSize>
        ...
        + ControllerCmdSync<LeEncrypt>
        + ControllerCmdSync<LeSetScanParams>
        + ControllerCmdSync<LeRand>
        + ControllerCmdSync<CmdLeReadSupportedStates>
        + ControllerCmdAsync<LeEnableEncryption>
        + ControllerCmdSync<CmdReadRssi>
        ...
        + ControllerCmdSync<LeSetAdvParams>,
{
    ...
    async fn read_remote_version_information(
        ...
        ReadRemoteVersionInformation::new(conn_handle.into())
            .exec(self)
            .await
            .map_err(|e| e.into())
    }
    ...
    async fn reset(&self) -> Result<(), Error> {
        Reset::new().exec(self).await.map_err(|e| e.into())
    }
    ...
    async fn read_tx_power_level(
        ...
        ReadTransmitPowerLevel::new(conn_handle.into(), power_level_type.into())
            .exec(self)
            .await
            .map_err(|e| e.into())
            .map(|ret| ret.tx_power_level)
    }
    ...
    async fn set_controller_to_host_flow_control(
        ...
        SetControllerToHostFlowControl::new(flow_control.into())
            .exec(self)
            .await
            .map_err(|e| e.into())
    }
    ...
    async fn host_buffer_size(&self, params: HostBufferSize) -> Result<(), Error> {
        CmdHostBufferSize::new(
            params.acl_data_packet_length,
            params.sync_data_packet_length,
            params.total_acl_data_packets,
            params.total_sync_data_packets,
        )
        .exec(self)
        .await
        .map_err(|e| e.into())
    ...
    async fn number_of_completed_packets(
        ...
        let packets = unsafe {
            slice::from_raw_parts(
                &params.data_buf as *const [u8; 254] as *const ConnHandleCompletedPackets,
                params
                    .num_handles
                    .min(size_of::<[u8; 254]>() / size_of::<ConnHandleCompletedPackets>()),
            )
        };

        HostNumberOfCompletedPackets::new(packets)
            .exec(self)
            .await
            .map_err(|e| e.into())
    }
    ...
    async fn read_local_version_information(&self) -> Result<LocalVersionInfo, Error> {
        ReadLocalVersionInformation::new()
            ...
            .await
            .map_err(|e| e.into())
            .map(|ret| LocalVersionInfo {
                hci_version: ret.hci_version.0,
                hci_revision: ret.hci_subversion,
                lmp_version: ret.lmp_version.0,
                manufacturer_name: ret.company_identifier,
                lmp_subversion: ret.lmp_subversion,
            })
    }
    ...
    async fn read_local_supported_commands(&self) -> Result<LocalSupportedCommands, Error> {
        ReadLocalSupportedCmds::new()
            ...
            .await
            .map_err(|e| e.into())
            .map(|ret| LocalSupportedCommands {
                supported_commands: ret.into(),
            })
    }
    ...
    async fn read_local_supported_features(&self) -> Result<LocalSupportedFeatures, Error> {
        ReadLocalSupportedFeatures::new()
            ...
            .await
            .map_err(|e| e.into())
            .map(|ret| LocalSupportedFeatures {
                supported_features: ret.into(),
            })
    }
    ...
    async fn read_rssi(&self, conn_handle: ConnectionHandle) -> Result<ReadRssi, Error> {
        CmdReadRssi::new(conn_handle.into())
            .exec(self)
            .await
            .map_err(|e| e.into())
            .map(|ret| ReadRssi {
                conn_handle: ret.handle.into(),
                rssi: ret.rssi,
            })
    }
    ...
    async fn le_read_buffer_size(&self) -> Result<LeReadBufferSize, Error> {
        CmdLeReadBufferSize::new()
            .exec(self)
            .await
            .map_err(|e| e.into())
            .map(|ret| LeReadBufferSize {
                data_packet_count: ret.total_num_le_acl_data_packets,
                data_packet_length: ret.le_acl_data_packet_length,
            })
    }

    async fn le_read_local_supported_features(&self) -> Result<LeSupportedFeatures, Error> {
        CmdLeReadLocalSupportedFeatures::new()
            .exec(self)
            .await
            .map_err(|e| e.into())
            .map(|ret| LeSupportedFeatures {
                supported_features: ret.into(),
            })
    }
    ...
    async fn le_set_random_address(&self, bd_addr: crate::BdAddr) -> Result<(), Error> {
        ...
        LeSetRandomAddr::new(bd_addr.into())
            .exec(self)
            .await
            .map_err(|e| e.into())
    }
    ...
    async fn le_set_advertising_parameters(
        ...
        if params.advertising_channel_map.is_empty() {
            return Err(Error::BadChannelMap(params.advertising_channel_map));
        }

        LeSetAdvParams::new(
            params.advertising_interval.interval.0.into(),
            params.advertising_interval.interval.1.into(),
            params.advertising_interval.advertising_type().into(),
            params.own_address_type.into(),
            params.peer_address.into(),
            params.peer_address.into(),
            params.advertising_channel_map.into(),
            params.advertising_filter_policy.into(),
        )
        .exec(self)
        .await
        .map_err(|e| e.into())
    ...
    async fn le_set_advertising_data(&self, data: &[u8]) -> Result<(), Error> {
        ...
        LeSetAdvData::new(data.len() as u8, buf)
            .exec(self)
            .await
            .map_err(|e| e.into())
    }
    ...
    async fn le_set_scan_response_data(&self, data: &[u8]) -> Result<(), Error> {
        ...
        LeSetScanResponseData::new(data.len() as u8, buf)
            .exec(self)
            .await
            .map_err(|e| e.into())
    }
    ...
    async fn le_set_scan_parameters(&self, params: &ScanParameters) -> Result<(), Error> {
        LeSetScanParams::new(
            params.scan_type.into(),
            params.scan_window.interval().into(),
            params.scan_window.window().into(),
            params.own_address_type.into(),
            params.filter_policy.into(),
        )
        .exec(self)
        .await
        .map_err(|e| e.into())
    ...
    async fn le_set_scan_enable(&self, enable: bool, filter_duplicates: bool) -> Result<(), Error> {
        LeSetScanEnable::new(enable, filter_duplicates)
            .exec(self)
            .await
            .map_err(|e| e.into())
    }
    ...
    async fn le_create_connection(&self, params: &ConnectionParameters) -> Result<(), Error> {
        LeCreateConn::new(
            ...
            params.peer_address.into(),
            match params.initiator_filter_policy {
                ConnectionFilterPolicy::WhiteList => BdAddr([0u8; 6]).into(),
                ConnectionFilterPolicy::UseAddress => params.peer_address.into(),
            },
            params.own_address_type.into(),
    ...
    async fn le_add_device_to_white_list(&self, addr: crate::BdAddrType) -> Result<(), Error> {
        LeAddDeviceToFilterAcceptList::new(addr.into(), addr.into())
            .exec(self)
            .await
            .map_err(|e| e.into())
    }
    ...
    async fn le_add_anon_advertising_devices_to_white_list(&self) -> Result<(), Error> {
        LeAddDeviceToFilterAcceptList::new(AddrKind::ANONYMOUS_ADV, BdAddr([0u8; 6]).into())
            .exec(self)
            .await
            .map_err(|e| e.into())
    }
    ...
    async fn le_remove_device_from_white_list(&self, addr: crate::BdAddrType) -> Result<(), Error> {
        LeRemoveDeviceFromFilterAcceptList::new(addr.into(), addr.into())
            .exec(self)
            .await
            .map_err(|e| e.into())
    }
    ...
    async fn le_remove_anon_advertising_devices_from_white_list(&self) -> Result<(), Error> {
        LeRemoveDeviceFromFilterAcceptList::new(AddrKind::ANONYMOUS_ADV, BdAddr([0u8; 6]).into())
            .exec(self)
            .await
            .map_err(|e| e.into())
    }
    ...
    async fn le_set_host_channel_classification(
        ...
        LeSetHostChannelClassification::new(channels.into())
            .exec(self)
            .await
            .map_err(|e| e.into())
    }
    ...
    async fn le_read_channel_map(
        ...
        LeReadChannelMap::new(conn_handle.into())
            .exec(self)
            .await
            .map_err(|e| e.into())
            .map(|ret| ChannelMapParameters {
                conn_handle: ret.handle.into(),
                channel_map: ret.channel_map.into(),
            })
    }
    ...
    async fn le_read_remote_used_features(
        ...
        LeReadRemoteFeatures::new(conn_handle.into())
            .exec(self)
            .await
            .map_err(|e| e.into())
    }
    ...
    async fn le_encrypt(&self, params: &AesParameters) -> Result<EncryptedReturnParameters, Error> {
        LeEncrypt::new(params.key.0, params.plaintext_data.0)
            .exec(self)
            .await
            .map_err(|e| e.into())
            .map(|ret| EncryptedReturnParameters {
                encrypted_data: EncryptedBlock(ret),
            })
    }
    ...
    async fn le_rand(&self) -> Result<LeRandom, Error> {
        LeRand::new()
            ...
            .map_err(|e| e.into())
            .map(|ret| LeRandom {
                random_number: u64::from_le_bytes(ret),
            })
    }

    async fn le_start_encryption(&self, params: &EncryptionParameters) -> Result<(), Error> {
        LeEnableEncryption::new(
            params.conn_handle.into(),
            params.random_number.to_le_bytes(),
            params.encrypted_diversifier,
            params.long_term_key.0,
        )
        .exec(self)
        .await
        .map_err(|e| e.into())
    ...
    async fn le_long_term_key_request_reply(
        ...
        CmdLeLongTermKeyRequestReply::new(conn_handle.into(), key.0)
            .exec(self)
            .await
            .map_err(|e| e.into())
    ...
    async fn le_long_term_key_request_negative_reply(
        ...
        LeLongTermKeyRequestNegativeReply::new(conn_handle.into())
            .exec(self)
            .await
            .map_err(|e| e.into())
            .map(|ret| LeLongTermRequestReply {
    ...
    async fn le_read_supported_states(&self) -> Result<LeReadSupportedStates, Error> {
        CmdLeReadSupportedStates::new()
            .exec(self)
            .await
            .map_err(|e| e.into())
            .map(|ret| LeReadSupportedStates {
                supported_states: LeStates::from_bits(u64::from_le_bytes(ret)).unwrap(),
            })
    }
    ...
    async fn le_transmitter_test(
        ...
        LeTransmitterTest::new([channel, payload_length as u8, payload as u8])
            .exec(self)
            .await
            .map_err(|e| e.into())
    }
...
impl From<TxPowerLevel> for PowerLevelKind {
    fn from(level: TxPowerLevel) -> Self {
        match level {
            TxPowerLevel::Current => PowerLevelKind::Current,
            TxPowerLevel::Maximum => PowerLevelKind::Maximum,
        }
    }
}
...
impl From<FlowControl> for ControllerToHostFlowControl {
    fn from(flow: FlowControl) -> Self {
        match flow {
            FlowControl::Both => ControllerToHostFlowControl::Off,
            FlowControl::HciAclDataOnly => ControllerToHostFlowControl::AclOnSyncOff,
            FlowControl::HciSyncDataOnly => ControllerToHostFlowControl::AclOffSyncOn,
            FlowControl::Off => ControllerToHostFlowControl::Off,
        }
    }
}
